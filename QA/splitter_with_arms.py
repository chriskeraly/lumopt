...
base_script_file_name = os.path.join(CONFIG['root'], 'examples/Ysplitter/splitter_with_arms.lsf')
...
fom = ModeMatch(monitor_name = 'fom', wavelengths = 1550e-9, mode_number = 2, direction = 'Forward')
...
optimizer = ScipyOptimizers(max_iter = 500, method = 'L-BFGS-B', scaling_factor = 1e6)
